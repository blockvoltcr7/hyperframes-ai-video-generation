---
version: alpha
name: Luminous Signature — Frame (video / frame layer)
description: >
  A premium dark keynote system for 1920×1080 teaching frames: near-black canvas, crisp white
  information, electric-blue and violet hierarchy, restrained pink terminal accents, Space Grotesk
  display, Inter body, minimal translucent surfaces, thin cool outlines, and a deliberately limited
  glow budget. Blue Professional supplies geometry and type hierarchy only.
...
colors:
  ...
  border: "rgba(220, 231, 255, 0.18)"
  card-bg: "rgba(7, 17, 31, 0.78)"
  positive: "#059669"
  negative: "#dc2626"
...
components:
  ...
  atmosphere:
    elements: "broad blue-violet edge light, restrained pink terminal bloom, crisp cool-white structural lines"
    description: "Strongest glow on one focal path; most labels and connectors do not glow."
  progress-bar:
    backgroundColor: "{colors.primary}"
